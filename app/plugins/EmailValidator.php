...
/**
 * EmailValidator exception handler
 */
...
class EmailValidator
{
    ...
    public function setEmailFrom($email)
    {
        if (!self::validate($email))
        {
            ...
            if ($this->exceptions)
            {
                throw new EmailValidatorException($this->ErrorInfo);
            }
        }
        $this->from = $email;
    }
     ...
     * @see EmailValidator::$Debugoutput
     * @see EmailValidator::$Debug
     * @param string $str
     */
     ...
     * If an error occurs, returns false
     * @access protected
     * @param integer $timed Time elapsed?
